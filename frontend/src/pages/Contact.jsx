    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className=' text-gray-500'>chandalike vittal <br /> Bantwala thaluku  574243</p>
          <p className=' text-gray-500'>Mob: 8123751408 <br /> Email: bharathgroup@gmail.com</p>
          <p className=' font-semibold text-lg text-gray-600'>CAREERS AT BHARATH GROUP</p>
