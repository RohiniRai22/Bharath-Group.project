...
const addService = async (req, res) => {
    ...
    try {
        ...
        const { name, email, password, speciality, model, experience, about, fees, address } = req.body
        const imageFile = req.file

        // checking for all data to add Service
        if (!name || !email || !password || !speciality || !model || !experience || !about || !fees || !address) {
